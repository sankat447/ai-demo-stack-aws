...
output "app_urls" {
  ...
  value = {
    ...
    open_webui     = "https://open-webui-ai-demo.apps.${var.cluster_name}.${var.base_domain}"
    n8n            = "https://n8n-ai-demo.apps.${var.cluster_name}.${var.base_domain}"
    ...
    portkey        = "https://portkey-ai-demo.apps.${var.cluster_name}.${var.base_domain}"
